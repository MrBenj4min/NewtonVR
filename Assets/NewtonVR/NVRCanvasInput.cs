...
namespace NewtonVR
{
    public class NVRCanvasInput : BaseInputModule
    {
        ...
        {
            return NVRPlayer.Instance.Hands[index].Inputs[NVRButtonId.NVR_Button_SteamVR_Trigger].PressDown;
        }

        private bool ButtonUp(int index)
        {
            return NVRPlayer.Instance.Hands[index].Inputs[NVRButtonId.NVR_Button_SteamVR_Trigger].PressUp;
        }
    }
}